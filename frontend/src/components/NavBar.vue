<template>
    <div class="header">
        ...
        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">Beranda</router-link>
            <router-link @click="scrollToTop()" to="/about">Tentang Kami</router-link>
        ...
        <div class="icons">
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Pesanan Saya</router-link>
                    </li>
                    <li>
